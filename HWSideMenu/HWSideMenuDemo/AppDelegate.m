...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    HWMessageViewController* messageViewController = [[HWMessageViewController alloc] init];
    ...
    HWLeftViewController* leftViewController = [[HWLeftViewController alloc] init];
    
    HWSideMenuViewController* sideMenu = [[HWSideMenuViewController alloc] initWithContentViewController:tabBar leftMenuViewController:leftViewController];
